...
REM 检查必要文件
if not exist "3d-map-tiff.html" (
    echo [错误] 找不到3d-map-tiff.html文件
    pause
    exit /b 1
)
...
start "" "http://%IP%:8000/3d-map-tiff.html"

echo.
echo [信息] 启动本地HTTP服务器...
echo [信息] 本地访问: http://localhost:8000/3d-map-tiff.html
echo [信息] 网络访问: http://%IP%:8000/3d-map-tiff.html
